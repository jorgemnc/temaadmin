...
# Rails.application.config.assets.precompile += %w( modern/vendors/charts/chartist-plugin-tooltip.js )
...
# Rails.application.config.assets.precompile += %w( modern/vendors/tables/datatable/datatables.min.js )
# Rails.application.config.assets.precompile += %w( modern/scripts/extensions/block-ui.js )
